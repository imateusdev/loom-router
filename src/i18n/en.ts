...
const en = {
  ...
  codex: {
    ...
    multiAgentDescription: 'Lets Codex expose its native spawn_agent tool. LoomRouter delegation also works without it, through loom_spawn_agents. New Codex sessions pick this up.',
    multiAgentWriteFailed: 'Could not update multi-agent. The previous state was kept.',
