...
const pt: DeepPartial<Strings> = {
  ...
  codex: {
    ...
    multiAgentDescription: 'Permite que o Codex crie subagentes e delegue aos seus agentes personalizados. Novas sessões do Codex usam isto.',
  ...
  agents: {
    ...
    savedNotice: 'Agente salvo. Novas sessões do Codex podem delegar para ele.',
    savedNoticeMultiAgent: 'Agente salvo e multi-agent ativado. Novas sessões do Codex podem delegar para ele.',
  },
  common: {
    loading: 'Carregando…',
