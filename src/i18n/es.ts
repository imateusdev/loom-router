...
const es: DeepPartial<Strings> = {
  ...
  codex: {
    ...
    activeModelRestart: 'Reinicia Codex para aplicar el cambio.',
    ...
    multiAgentDescription: 'Permite que Codex cree subagentes y delegue en tus agentes personalizados. Reinicia Codex después de activarlo.',
