...
const es: DeepPartial<Strings> = {
  ...
  providers: {
    ...
    enableFailed: 'No se pudo activar {{model}}',
  ...
  codex: {
    ...
    multiAgentDescription: 'Permite que Codex exponga su herramienta nativa spawn_agent. La delegación de LoomRouter también funciona sin esto, mediante loom_spawn_agents. Las nuevas sesiones de Codex lo usan.',
    multiAgentWriteFailed: 'No se pudo actualizar multi-agente. Se mantuvo el estado anterior.',
