...
const es: DeepPartial<Strings> = {
  ...
  providers: {
    ...
    promptCache: 'Caché de prompt',
    promptCacheOff: 'Desactivada',
    promptCacheFiveMinutes: '5 minutos (recomendado)',
    promptCacheOneHour: '1 hora',
    promptCacheHint: 'Reutiliza prefijos estables mediante Anthropic. Una retención mayor cuesta más al escribir.',
    promptCacheProviderDefault: 'Predeterminado del proveedor',
    promptCacheHybridHint: 'Usa el valor del proveedor, salvo que se elija un TTL explícito para modelos compatibles.',
    promptCacheAutomatic: 'Automática por el proveedor',
    promptCacheAutomaticHint: 'No requiere configuración de LoomRouter. Los prefijos estables mejoran los aciertos.',
    promptCacheExternal: 'Gestionada por Claude Code',
    promptCacheExternalHint: 'Claude Code CLI local y su backend controlan la caché de prompt.',
    promptCacheUnavailable: 'Sin control de caché documentado',
    promptCacheUnavailableHint: 'LoomRouter no envía campos de caché no verificados a este proveedor.',
